...
- Option to save progress to pixela. You need to set up a user account, create a graph, and obtain a token for the API: https://pixe.la/. Put this info in pixela_creds.yaml. 
