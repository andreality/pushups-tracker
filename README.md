...
- To track pushups using pixela API, use run_setup.py to create a pixela account and add your graph. (example: https://pixe.la/v1/users/andreality/graphs/pushups.html)
